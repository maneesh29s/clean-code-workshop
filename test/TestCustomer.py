...
You earned 4 frequent renter points""")
    ...
    def test_should_generate_html_statement_when_asked(self):
        ...
        self.assertEqual(customer.html_statement(), """<h1>Rental Record for Maneesh</h1><br><p>Spiderman	30<br>Batman	21.5<br>Barbie	4.5<br>Amount owed is 56.0<br>You earned 4 frequent renter points</p>""")
